        ...
        <div class="bodyContent">
            ...
            <section>
                <div id="divCards">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="img/trabalhe_conosco.png" alt="Horário de atendimento">
                        <div class="card-body">
                            <h5 class="card-title">Quer trabalhar conosco?</h5>
                            <p class="card-text">Envie seu currículo para nosso email!</p>
                            <p class="card-text">taruma@rh.com.br</p>
                        </div>
                    </div>
                </div>
                <div>
